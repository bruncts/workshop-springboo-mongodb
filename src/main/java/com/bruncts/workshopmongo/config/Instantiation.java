...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post pos1 = new Post(null,sdf.parse("30/08/2022"),"Let's go to Brazil!","I gonna travel to Brazil!",maria);
		Post pos2 = new Post(null,sdf.parse("31/08/2022"),"Good Morning Brazil","I waked up in other country today.",maria);
